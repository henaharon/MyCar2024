...
const additionalWitnessesPlaceholder =
  'במידה ויש עדים נוספים אנא עדכן כאן, יש להקפיד למלא את שמם המלא, ת.ז, כתובת וטלפון של כל העדים הנוספים.';
...
const additionalInjuredPlaceholder =
  ...
  return (
    <BodyBaseView style={styles.bodyContainer}>
      ...
      <View style={{marginLeft: windowWidth * 0.08}}>
        <ChoiceInput
          optionF={'לא היו נפגעים'}
          optionT={'כן, היו נפגעים'}
          setChoice={setInjured}
        />
      </View>
      {injured && (
        <View style={styles.InfoContainer}>
          ...
          <View style={styles.witnessForm}>
            ...
            />
            <TextareaInput
              title={additionalInjuredTitle}
              placeholder={additionalInjuredPlaceholder}
            />
          </View>
      ...
      {witnesses && (
        <View style={styles.InfoContainer}>
          ...
          <TextareaInput
            title={additionalWitnessesTitle}
            placeholder={additionalWitnessesPlaceholder}
          />
          <View style={styles.witnessPhotos}>
