  ...
  return (
    <BodyBaseView style={styles.bodyContainer}>
      <View style={styles.carDamageForm}>
        ...
        <ChoiceInput
          optionF={'הרכב לא ניזוק'}
          optionT={'כן, הרכב ניזוק'}
          setChoice={setCarDamage}
        />
        {carDamage && (
          <View>
            <View style={styles.carDamageInputContainer}>
              <CarDamageInputs
                ...
                infoPlaceholder={damageDescriptionPlaceholder}
      ...
      <View style={styles.carDamageForm}>
        ...
        <ChoiceInput
          optionF={'הרכב לא ניזוק'}
          optionT={'כן, הרכב ניזוק'}
          setChoice={setAssosiativeDamage}
        />
        {associativeDamage && (
          <View>
            <View style={styles.carDamageInputContainer}>
              <CarDamageInputs
                infoTitle={associativeInfoTitle}
                infoPlaceholder={damageDescriptionPlaceholder}
                imageTitle={imagesTitle}
              />
            </View>
